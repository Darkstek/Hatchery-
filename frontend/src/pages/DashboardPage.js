...
function TempStatus({ temp, msg, tempMin, tempMax }) {
  ...
  if (temp === null)
    return (
      <span style={{ color: "#94a3b8", fontWeight: 700 }}>SENZOR OFFLINE</span>
    );
  if (temp < tempMin)
    return (
      <span style={{ color: "#60a5fa", fontWeight: 700 }}>PŘÍLIŠ CHLADNO</span>
    );
  if (temp > tempMax)
    return (
      <span style={{ color: "#f87171", fontWeight: 700 }}>PŘÍLIŠ TEPLO</span>
    );
  ...
  return (
    <div style={sliderStyles.wrapper}>
      <div style={sliderStyles.header}>
        ...
        <span style={sliderStyles.values}>
          {tempMin}°C – {tempMax}°C
        </span>
      </div>
      <div
        ...
        <div style={styles.cardRow}>
          <div style={styles.card}>
            ...
            <p style={styles.cardSub}>
              Optimální rozsah: {tempMin}°C – {tempMax}°C
            </p>
          </div>
